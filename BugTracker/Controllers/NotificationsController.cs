...
namespace BugTracker.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Notifications.Include(n => n.NotificationType).Include(n => n.Project).Include(n => n.Ticket);
        ...
        public async Task<IActionResult> Create([Bind("Id,ProjectId,TicketId,Title,Message,Created,SenderId,RecipientId,NotificationTypeId,Viewed")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProjectId,TicketId,Title,Message,Created,SenderId,RecipientId,NotificationTypeId,Viewed")] Notification notification)
        {
